...
<meta charset="ISO-8859-1">
    ...
    <div class="container_actualizar_contraseña">
    	...
    	<form action = "ServletRecuperarContraseña?action=actualizar" method = "post" id="miformulario">
    	
    	 <input type="hidden" name="codigo" value="<% out.print(request.getAttribute("codigo")); %>">
    		...
    		<div class="container-input">
				...
				<label for="Confirmar password" class="confirmarpassword">Confirmar nueva contraseña</label>
          			<div class="input_confirmar_password">
           				 <input type="password" class="input_confirmar_password" id="confirmarpassword" name="contrasena" placeholder="Confirmar la nueva contraseña" required size="15" pattern="(?=\w*\d)(?=\w*[A-Z])(?=\w*[a-z])\S{8,16}$" title="La contraseña debe tener entre 8 y 16 caracteres, al menos un dígito, al menos una minúscula y al menos una mayúscula.">
        	 			 <span class="validity"></span>
          		    </div>
